 ...
 */
class PlanoTipoController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all PlanoTipo models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new PlanoTipoSearch();
    ...
    /**
     * Displays a single PlanoTipo model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing PlanoTipo model.
    ...
    /**
     * Deletes an existing PlanoTipo model.
    ...
    /**
     * Finds the PlanoTipo model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return PlanoTipo the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PlanoTipo::findOne(['id' => $id])) !== null) {
            return $model;
        }
